package Locale::Country::SubCountry::Util::Config;
...
L<Locale::Country::SubCountry::Util::Config> - Country names in English, and subcountry names in native scripts
...
The path to the config file is determined by:
	...
	Path::Class::file(File::HomeDir -> my_dist_config('Locale-Country-SubCountry'), '.htlocale.country.subcountry.conf');
